...
const listings: Listing[] = [
  {
    ...
    rating: 4.6,
    reviewCount: 32,
    tag: "Top pick · Close to city centre",
  },
  {
    id: 2,
    name: "Headingley Studios",
    area: "Headingley",
    price: 620,
    rating: 4.3,
    reviewCount: 18,
    tag: "Student favourite · Great nightlife",
  },
  {
    id: 3,
    name: "Sherwood House",
    ...
    rating: 3.9,
    reviewCount: 9,
    tag: "Budget friendly · Quiet street",
  },
  {
    id: 4,
    name: "Woodsley Road Flats",
    area: "Woodhouse",
    price: 540,
    rating: null,
    reviewCount: 0,
    tag: "New listing · Be the first to review",
  },
  {
    id: 5,
    name: "Cardigan Heights",
    area: "Headingley",
    price: 610,
    rating: 4.5,
    reviewCount: 14,
    tag: "Top pick · Close to campus",
  },
  {
    id: 6,
    name: "Burley Lodge Court",
    area: "Burley",
    price: 495,
    rating: null,
    reviewCount: 0,
...
const recentReviews: Review[] = [
  {
    id: 1,
    listingId: 4,
    listingName: "Woodsley Road Flats",
    area: "Woodhouse",
    rating: 4,
    quote:
      "Really solid for the price. The en-suites were newly refurbished and the location is unbeatable — 8 minutes walk to...",
    reviewerInitials: "JT",
  ...
  },
  {
    id: 2,
    listingId: 6,
    listingName: "Burley Lodge Court",
    area: "Burley",
    rating: 5,
    quote:
      "Best year of my life honestly — huge rooms, great housemates, and the landlord was genuinely one of the kinde...",
    reviewerInitials: "PS",
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F5F1E9] font-sans">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p className="max-w-xs sm:max-w-md text-sm sm:text-base text-zinc-200 mb-5 sm:mb-8 font-light px-2">
            Honest reviews from Leeds students, for Leeds students. No spin,
            no landlord edits.
          </p>

          <form
            onSubmit={handleSearch}
            className="w-full max-w-4xl bg-[#F5F1E9] rounded-full shadow-xl p-2 sm:p-3 flex items-center mt-3 sm:mt-5"
          >
            <Search className="ml-4 text-[#84ab95]" size={24} />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-10 mb-12">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-zinc-300 font-serif text-sm mb-2">
                01
              </span>

              <h3 className="font-serif font-medium text-lg text-zinc-900 mb-2">
                Search
              </h3>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-zinc-600 text-sm max-w-xs font-light">
                See real experiences written by students who've actually lived
                there. No paid placements, no landlord edits.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 rounded-full bg-white border border-zinc-200 flex items-center justify-center mb-2">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M3 12l2-2m0 0l7-7 7 7m-9 2v8m0-8l2-2m7 2v8a1 1 0 01-1 1H4a1 1 0 01-1-1v-8"
                  />
                </svg>
              </div>
              ...
              <p className="text-zinc-600 text-sm max-w-xs font-light">
                Lived somewhere in Leeds? Add your review to help the next
                student.
              </p>
            </div>
          </div>
          ...
          <Link
            href="/browse"
            className="inline-block bg-[#84ab95] hover:bg-[#76886F] text-white rounded-full px-8 py-3 font-medium transition-colors"
          >
      ...
      <section
        id="write-review"
        className="bg-black text-white px-8 py-20 text-center"
      >
        ...
        <p className="text-zinc-200 max-w-md mx-auto mb-8 font-light">
          Your honest review helps other students make better decisions. It
